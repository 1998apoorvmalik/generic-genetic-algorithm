...
class EightPuzzleExample(GeneticAlgorithm):
    def __init__(self, board=None, solution_size=80, heuristic="a", display_documentation=True):
        ...
        super(EightPuzzleExample, self).__init__(
